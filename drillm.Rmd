...
_NOTE: Execution data is NOT completely accurate. A few (3-5) executions failed and, as a result, we have no record of it._
...
write_csv(models_summary, paste(OUTPUT_DIR, "models_summary.csv", sep = "/"))
