...
models %>%
  ...
  kable(caption = "LLMs", row.names = TRUE, col.names = c("Provider", "Model", "Series", "Parameters (B)", "Context Length", "Architecture", "Version"))
...
kable(excluded_models %>% arrange(provider, model), caption = "Excluded models and reasons", col.names = c("Provider", "Model", "Reason for exclusion"))
...
kable(llm_scores, caption = "LLM Performance Metrics Against Human DRI Post-Scores", digits = 3, col.names = c(
    model = "Model",
    MAE = "MAE",
    RMSE = "RMSE",
    MAPE = "MAPE (%)",
