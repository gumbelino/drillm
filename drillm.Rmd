...
SURVEY_FILE <- "data/surveys_v3.xlsx"
...
study_survey_map <- read_csv("data/study_survey_map.csv")
...
get_DRI <- function(data) {
  ...
  ## INDIVIDUAL DRI ##
    ...
    # Define a new row as a named list or tibble
    group_row <- tibble(
      Participant = "Group",
      DRI = !!DRI
    )
...
# Add the new row to the dataframe
    DRIInd <- bind_rows(DRIInd, group_row)
